...
public:
    ...
    virtual bool OnEvent(uint32_t code, void *data)
    {
        return false;
    }

    template <typename Destination>
        requires std::derived_from<Destination, Layer>
    void Transition();
...
public:
    ...
    template <typename Source, typename Destination>
        requires std::derived_from<Source, Layer> && std::derived_from<Destination, Layer>
    void Transition()
    {
