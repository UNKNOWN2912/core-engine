...
class Scene
{
    public:
        ...
        ComponentType& AddComponent(const Entity& entity, Args ...args)
        {
            ...
            ComponentStorage<ComponentType>* storage = (ComponentStorage<ComponentType>*)mStorage.emplace_back
            (ComponentStoragePair(componentId, new ComponentStorage<ComponentType>))
                    .second.get();
    ...
    private:
        ...
        EntityId mLastId = (EntityId)UINT32_MAX;
};
